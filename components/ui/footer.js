...
const navigation = {
  ...
  social: [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/mukilteorobotics/',
      icon: (props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/Mukilteo-Robotics',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@mukilteorobotics',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer className="bg-neutral-200/20 backdrop-blur-sm mt-24 border-neutral-400/10 border">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; 2023 Mukilteo Robotics. All rights reserved.
        </p>
