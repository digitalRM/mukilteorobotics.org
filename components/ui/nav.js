...
export default function Nav() {
  ...
  return (
    <header className="border-b dark:bg-slate-700/50 dark:border-slate-700/50 border-zinc-300 w-screen fixed backdrop-blur-xl bg-neutral-100 sm:bg-neutral-100/70 z-10 ">
